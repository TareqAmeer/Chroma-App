...
- Traffic-light padding + `data-tauri-drag-region` only when `CS_PLATFORM.os==='macos'` (native
  frame on Windows, per the decision above). Still open.
