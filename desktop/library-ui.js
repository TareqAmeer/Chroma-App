...
(function () {
  ...
  const DS_FONTS = `
    ...
    #lib-overlay{
      /* TOKENS:DS:START — generated by scripts/build-tokens.mjs from design/tokens.json; edit values/notes there, not here */      --blue-slate:#224455;--blue-slate-focus:#2a5468;--blue-slate-press:#1a3644;
