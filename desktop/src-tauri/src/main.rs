...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            library::get_sidecar,
            library::get_sidecar_batch,
            library::sidecar_add_version,
            library::sidecar_set_active_version,
            ...
            catalog::catalog_confirm_person,
            catalog::catalog_split_faces,
