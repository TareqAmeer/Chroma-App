...
This encodes CLAUDE.md §6 lessons 1–3, which were each learned expensively. The order below
...
in CLAUDE.md §5. Read that before changing the model shape, not just the constants — the
